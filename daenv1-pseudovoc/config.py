...
config_dict = {
		...
		'DATA_RANDOM_V': 10,
		'DATA_RANDOMFLIP': 0.5,
		'DATA_PSEUDO_GT': '/home/***/project/DAEN/out_rw',
...
config_dict['TEST_CKPT'] = os.path.join(config_dict['ROOT_DIR'],'model/daenv1-pseudovoc/deeplabv1_resnet38_VOCDataset_itr20000_all.pth')
